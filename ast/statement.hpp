...
struct CallSt : public StatementBase {
  ...
  bool operator==(const CallSt& other) const { return true; }
  bool operator!=(const CallSt& other) const { return false; }
...
struct Break : public StatementBase {
  ...
  bool operator!=(const Break& other) const { return false; }
};
...
struct Return : public StatementBase {
  ...
  bool operator!=(const Return& other) const { return false; }
};
...
struct WhenSt;
struct WhileSt;
typedef variant<Assign, Break, Return, CallSt, recursive_wrapper<IfSt>, recursive_wrapper<ForSt>, recursive_wrapper<WhenSt>,
