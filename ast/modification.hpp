...
struct ModClass;
typedef boost::variant<ModEq, ModAssign, boost::recursive_wrapper<ModClass>> Modification;
template <typename T>
...
struct ElRedecl;
struct ElRepl;
typedef boost::variant<ElMod, boost::recursive_wrapper<ElRepl>, boost::recursive_wrapper<ElRedecl>> Argument;
template <typename T>
