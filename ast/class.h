...
typedef boost::variant<EquationSection, StatementSection, Public, Protected> CompElement;
...
typedef boost::variant<Class, DefClass, EnumClass, DerClass, ExtendsClass> ClassType;
