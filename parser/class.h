...
struct ClassRule : qi::grammar<Iterator, Skipper<Iterator>, StoredDef()> {
  ...
  /* Operators tokens */
  qi::rule<Iterator> EQUAL, IMPORT, EXTENDS, DOT, STAR, OBRACE, COMA, CBRACE, IF, SEMICOLON, PUBLIC, PROTECTED, OPAREN, CPAREN, DER,
      ENUMERATION, EXTERNAL, END, ENCAPSULATED, FINAL, WITHIN, REPLACEABLE, REDECLARE, INNER, OUTER;
