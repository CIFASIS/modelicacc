...
class MatchingGraphBuilder {
  ...
  SBG::PWLMap buildPWLMap(SBG::contREAL constants, SBG::contREAL slopes, SBG::Set dom);
  ...
  void addDims(size_t max_dim, size_t exp_dim, SBG::contREAL& constant, SBG::contREAL& slope);
