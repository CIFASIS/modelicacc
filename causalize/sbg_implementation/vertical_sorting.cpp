...
std::vector<SBG::LIB::Set> sortSets(const SBG::LIB::PWMap& sort
  , std::vector<SBG::LIB::Set> sets, SBG::LIB::Set start)
{
...
std::vector<LoopT> VerticalSortingResult::groupLoops(
  std::vector<SBG::LIB::Set> modelica_sort, std::vector<LoopT> loops) const
{
...
VerticalSortingResult VerticalSorting::sort()
{
  ...
  SBG::LIB::PWMap vertical_sort = SBG::LIB::TopologicalSorting{}.calculate(
    vertical_dsbg, _loops_result.scc_result().rmap());
