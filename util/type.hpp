...
typedef variant<Integer, String, Boolean, String, Real, TypeDef, EnumType, recursive_wrapper<Array>, recursive_wrapper<Tuple>,
                recursive_wrapper<Function>, recursive_wrapper<Class>>
    Type;
