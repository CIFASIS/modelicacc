...
#include <util/ast_visitors/replace_index.h>
...
namespace Modelica {
    ...
    Expression ReplaceIndex::operator()(Boolean v) const { 
      return v;
    }
    Expression ReplaceIndex::operator()(String v) const {
      return v;
    }
    Expression ReplaceIndex::operator()(Name v) const { 
      return v;
    }
    Expression ReplaceIndex::operator()(Expression v) const { 
      return v;
    }
    Expression ReplaceIndex::operator()(SubAll v) const { 
      return v;
    }
    Expression ReplaceIndex::operator()(SubEnd v) const { 
      return v;
    }
    ...
    Expression ReplaceIndex::operator()(Bracket v) const { 
      return v;
    }
