...
[({{[700001:1:800000]}}, [2 * x + -1.1e+06]) , ({{[300001:2:499999]}}, [1 * x + 0]), ({{[600001:1:700000]}}, [2 * x + -1.2e+06]), ({{[1:2:199999]}}, [1 * x + 0]), ({{[500001:1:600000]}}, [2 * x + -700000]), ({{[300002:2:500000]}}, [1 * x + 0]), ({{[200001:1:300000]}}, [2 * x + -400000]), ({{[2:2:200000]}}, [1 * x + 0])]
...
equation
  ...
  for i in 1:2:199999 loop
    R_p_fl[1*i+0]+C2_p_fl[0.5*i+0.5] = 0;
  end for;
  for i in 1:1:100000 loop
  ...
  for i in 2:2:200000 loop
    R_p_fl[1*i+0]+C1_p_fl[0.5*i+0] = 0;
  end for;
  for i in 1:1:100000 loop
